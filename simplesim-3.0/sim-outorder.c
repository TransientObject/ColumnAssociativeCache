...
"  Predictor `comb' combines a bimodal and a 2-level predictor.\n"
  ...
  opt_reg_string(odb, "-pseudoassoc", "enable pseudo associativity for directly mapped cache {true|false}", &pseudoassoc, "false", TRUE, NULL);
		  ...
		  int argc, char **argv)        /* command line arguments */
{
  ...
  if(mystricmp(pseudoassoc, "true") && mystricmp(pseudoassoc, "false"))
    {
      printf("FATAL - pseudoassoc can take only two values (true|false). If you dont give an value, default is false\n");
      fatal("pseudoassoc can take only two values (true|false)\n");
    }
  ...
  if (!mystricmp(cache_dl1_opt, "none"))
	...
	fatal("bad l1 D-cache parms: <name>:<nsets>:<bsize>:<assoc>:<repl>");
      ...
      /* set the cache property to true if the command line says so*/
      if (!mystricmp(pseudoassoc, "true"))
        {
          cache_dl1->pseudoassociative = 1;
          cache_dl1->tag_shift -= 1;
        }
